        ...
        <> 
            <div className="text-stone-200">
                <>
                    ...
                    <h3><strong>Type:</strong> {cardData.data?.[currentCard].type_line ?? "Not listed"}</h3>
                    <h3><strong>Set:</strong> {cardData.data?.[currentCard].set_name ?? "Not listed"}</h3>
                    <h3><strong>Price:</strong> {cardData.data?.[currentCard].prices?.usd ?? "Not listed"}</h3>
                    <h3><strong>Artist:</strong> {cardData.data?.[currentCard].artist ?? "Not listed"}</h3>
                </>
            </div>
        </>
        )
